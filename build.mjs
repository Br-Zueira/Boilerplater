...
try {
    ...
    // Sql.js
    copy(['node_modules/sql.js/dist/sql-wasm.js', 'node_modules/sql.js/dist/sql-wasm.wasm'], 'sql-js');
    
    // Tom-Select
    copy(['node_modules/tom-select/dist/js/tom-select.complete.js', 'node_modules/tom-select/dist/css/tom-select.css'], 'tom-select');
