    ...
    switch (model) {
        ...
        case ("languages"): {
            return /*HTML*/`
                <label>
                    <h2>Display name:</h2>
                    <input type="text" name="displayName" value="${object.displayName}" placeholder="LoremipsumScript" required>
                </label>
                <label>
                    <h2>Internal name (Automatically generated by the system):</h2>
                    <input type="text" name="internalName" value="${object.internalName}" placeholder="loremipsumscript" required readonly>
                </label>
            `;
        }
        case ("tags"): {
